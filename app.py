"""
TalentSphere Elevate — AI-Powered Career Guidance Platform
...
# ----------------------------------------------------------------
st.set_page_config(
    page_title="TalentSphere Elevate | AI Career Guidance",
    page_icon="🌐",
    layout="wide",
...
def page_login():
    ...
    with mid:
        ...
        render_auth_header("🌐", "TalentSphere Elevate", "AI-Powered Career Guidance Platform")
...
def page_signup():
    ...
    with mid:
        st.markdown('<div class="auth-wrapper">', unsafe_allow_html=True)
        render_auth_header("🌐", "Join TalentSphere Elevate", "Start your personalized career journey today")
...
def render_user_sidebar(user):
    with st.sidebar:
        st.markdown('<div class="sidebar-brand">🌐 TalentSphere Elevate</div>', unsafe_allow_html=True)
        st.markdown(f"""
