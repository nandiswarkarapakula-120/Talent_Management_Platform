"""
Talent Management Platform - AI Engine
...
QUIZ_BANK = {
    ...
    "Math": [
        {"q": "What is the value of π (pi) rounded to 2 decimal places?", "options": ["3.14", "3.41", "3.12", "3.16"], "answer": "3.14"},
        {"q": "Solve for x: 2x + 6 = 20", "options": ["6", "7", "8", "9"], "answer": "7"},
        {"q": "What is the square root of 144?", "options": ["10", "11", "12", "14"], "answer": "12"},
        {"q": "What is the area of a rectangle with sides 8 and 5?", "options": ["13", "40", "45", "35"], "answer": "40"},
    ...
    "Science": [
        ...
        {"q": "Which force keeps planets in orbit around the sun?", "options": ["Magnetism", "Gravity", "Friction", "Tension"], "answer": "Gravity"},
    ...
    "English": [
        {"q": "Choose the correctly spelled word:", "options": ["Recieve", "Receive", "Receve", "Receeve"], "answer": "Receive"},
        {"q": "Identify the noun in: 'The quick fox jumps.'", "options": ["Quick", "Fox", "Jumps", "The"], "answer": "Fox"},
        {"q": "Antonym of 'Ancient':", "options": ["Old", "Modern", "Historic", "Aged"], "answer": "Modern"},
        {"q": "Which sentence is grammatically correct?", "options": ["She don't like it", "She doesn't likes it", "She doesn't like it", "She not like it"], "answer": "She doesn't like it"},
        {"q": "What type of word is 'quickly'?", "options": ["Noun", "Verb", "Adverb", "Adjective"], "answer": "Adverb"},
    ],
    "Social Studies": [
        {"q": "Which is the longest river in the world?", "options": ["Amazon", "Nile", "Ganges", "Yangtze"], "answer": "Nile"},
        {"q": "Who was the first President of the United States?", "options": ["Abraham Lincoln", "Thomas Jefferson", "George Washington", "John Adams"], "answer": "George Washington"},
        {"q": "Which continent is the Sahara Desert located in?", "options": ["Asia", "Africa", "Australia", "South America"], "answer": "Africa"},
        {"q": "The concept of 'Democracy' originated in which ancient civilization?", "options": ["Rome", "Egypt", "Greece", "China"], "answer": "Greece"},
        {"q": "What does GDP stand for?", "options": ["Gross Domestic Product", "General Development Plan", "Global Development Product", "Gross Development Price"], "answer": "Gross Domestic Product"},
    ],
}
