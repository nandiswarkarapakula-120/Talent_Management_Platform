"""
Talent Management Platform - PDF Generator
...
def generate_certificate(fullname, course_title, cert_code, issued_on=None):
    ...
    c.setFillColor(PRIMARY)
    c.drawCentredString(W / 2, H - 3.3 * cm, "🌐 Talent Management Platform")

    c.setFont("Helvetica", 12)
    c.setFillColor(DARK)
    c.drawCentredString(W / 2, H - 4.0 * cm, "Talent Management Platform for Employee Performance & Career Growth")
    ...
    c.drawRightString(W - 2.5 * cm, 1.8 * cm, "Talent Management Platform Team")
...
def generate_report_pdf(title, fullname, sections: dict):
    ...
    c.drawString(1.5 * cm, H - 1.3 * cm, "🌐 Talent Management Platform")
...
def generate_verification_report(user, profile_extra, sections: dict, verification_code):
    ...
    c.drawString(1.5 * cm, H - 1.4 * cm, "🌐 Talent Management Platform — Profile Verification Report")
    ...
    c.drawString(2 * cm, 1.3 * cm, f"This report was generated by Talent Management Platform and can be re-verified using code {verification_code}.")
